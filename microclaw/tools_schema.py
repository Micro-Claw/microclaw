            ...
            "properties": {
                ...
                "parameters": {
                    ...
                    "description": (
                        ...
                        "project_path, background_label, numerator_label and "
                        "denominator_label; the label names must be the project's "
                        "own, which its refusal will list for you. project_sha256 is "
                        "OPTIONAL — the project is hashed and recorded either way, and "
                        "supplying one turns that into a check. Do not ask the user for "
                        "a digest. "
