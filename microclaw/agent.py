...
SYSTEM_PROMPT = (
    ...
    "\n"
    "Guidelines:\n"
    "- Be sure to keep the laser off when the camera is off, unless it is absolutely needed."
    "This avoids sample bleaching. Whenever live mode ends, be sure to turn the laser off."
    ...
    "\n"
    "Nikon rigs:\n"
    "- Nikon systems often use the Perfect Focus System (PFS) as the focus lock. If you see" 
    "TIPFS hardware, you can use this to identify the focus. TIPFSStatus-Status tells you if" 
    "you are focusing, regardless of whether or not the PFS is on. Just move the Z stage and"
    "check this property. Once it is in range of focus, the focus lock can be engaged."
    "- Once the PFS is on, use an image-based focusing metric to confirm there is signal."
    "Youu can use the PFSOffset to fine tune the focus, using image-based focusing metrics "
