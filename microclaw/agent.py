...
SYSTEM_PROMPT = (
    ...
    "in-range values to probe; use method='sweep' and a reviewed wide window. The "
    "tool records the full plane-to-reading table, centres on a contiguous band, and "
    "costs no exposures. Once it is in range of focus, the focus lock can be engaged.\n"
