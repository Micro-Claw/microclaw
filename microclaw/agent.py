...
SYSTEM_PROMPT = (
    ...
    "- Once the PFS is on, you can use the PFSOffset to fine tune the focus, using image-based"
    "focusing metrics to improve the contrast."
    "- The PFS has a decent chance of focus-locking too high, with the sample lifted by the" 
    "objective. To mitigate this, try doing an image-based autofocusing routine first. Then"
    "switch to using the PFS with a fine-tuned search around the image-based autofocus."
    "User knowledge base:\n"
