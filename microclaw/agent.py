...
SYSTEM_PROMPT = (
    ...
    "see TIPFS hardware, you can use this to identify the focus. TIPFSStatus-Status "
    "tells you if you are focusing, regardless of whether or not the PFS is on. Just "
    "move the Z stage and check this property. Once it is in range of focus, the focus "
    "lock can be engaged.\n"
