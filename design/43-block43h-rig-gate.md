...
Implementation ancestor: 43d0bbb
...
## Step 0 — pin and run the full Windows suite
    ...
    git merge-base --is-ancestor 43d0bbb HEAD
...
Expected on the Windows rig for this branch: **1702 passed + 116 skipped = 1818
...
same host; stop if tests failed, collection is not 1818, or the skip count rose.
...
Pass when the file reports 69 passed. It covers all three seed shapes, exact
