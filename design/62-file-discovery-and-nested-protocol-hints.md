...
| 62c | **assigned 2026-09-01**, branch `design62/protocol-preflight` off `65fe5a3`, runner in its own worktree. Decision 3 only. Read F5 before reviewing it |
