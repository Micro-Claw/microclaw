...
| 62d | **assigned 2026-09-01**, branch `design62/inspect-artifacts-discovery` off `54991bf`, runner in its own worktree. Decision 5, acceptance tests 10–14. Read F6 before reviewing it. Its demo-machine limb is the only gate design/62 asks anyone to run |
