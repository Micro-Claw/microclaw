...
- **Status** — OPEN - no fixture package exists; `design/71`'s feasibility section is written against SMAPpy 0.1.0, whose release is not ours to schedule (see R85). **Owned by `design/83` as of 2026-09-22**, which split it: 83a supplies both fixture manifests and assets, 83c adds the executable fixture's runner and executes it against the protocol it specifies.
