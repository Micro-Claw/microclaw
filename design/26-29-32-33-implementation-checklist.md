...
| 9 | `design29/stage-coordinate-mosaic` | `fecb93b` | through `bd63d37` (3 blockers + 2 + 2 coordinator rounds); 1092/99/3 | **PENDING — 2 of 3 prerequisites discharged (fixtures retrieved, 2500-tile scale gate passed at 3.4 s / 723 MB). Merge gated on the rig gate in `design/29-block9-rig-gate-prompts.md` (R1–R5) plus the landmark check.** Review caught a mosaic that rendered solid tiles as stripes | | |
