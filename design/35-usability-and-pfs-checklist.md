...
| 45 | Platform | none — **assign first, before Track C** | `design45/saved-hook-repair` | | | **demo sufficient for the mechanism**; M5 only to re-save the migrated hooks and confirm `list_hooks` reports twelve resolvable | | |
