...
| 45 | Platform | none — **assign first, before Track C** | `design45/saved-hook-repair` | `9855fe8` | | **demo sufficient for the mechanism**; M5 only to re-save the migrated hooks and confirm `list_hooks` reports twelve resolvable. Suite baseline at the branch point, macOS: **1811 passed / 99 skipped / 3 warnings**, coordinator-measured, equal to 43n's close | | |
