...
- **43n is assigned from `ddbf91a`**, branch `design43/acquire-on-hit`, ledger row
...
- **Suite baseline: 1800 passed / 99 skipped / 3 warnings, 1899 collected** on
  macOS at `ddbf91a`, re-measured at assignment. Unchanged since 43j merged,
