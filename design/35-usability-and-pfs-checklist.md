...
| 9a | Features | 45 merged; **branch gate discharged 2026-08-24 — the `.ilp` exists and is hashed** | `design26/generated-adapter-run-b` | `7d2bb9c` | | **Assigned 2026-08-24**, Codex runner in worktree `../microclaw-9a`. Suite baseline at the branch point, macOS, **coordinator-measured**: **2100 passed / 99 skipped / 3 warnings = 2199 collected**; Windows expectation 2083 + 116 = 2199. | |
